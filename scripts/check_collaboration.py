...
fixture=ROOT/'tests/evidence/colaborativo-prueba.html'
identity='prueba-colab-'+uuid.uuid4().hex
fixture.write_text(build('Prueba de revisión',[{'id':'contenido','titulo':'Prueba','html':(ROOT/'examples/content/collaborative-content.html').read_text()}],theme='linear-light',style='sobrio',document_id=identity))
try:
 call('goto','--url','http://127.0.0.1:8768/tests/evidence/colaborativo-prueba.html');call('screenshot')
...
for theme in ['linear-light','linear-dark']:
 ...
 shot=call('screenshot');(ROOT/'tests/screenshots'/('colaboracion-'+theme+'.png')).write_bytes(base64.b64decode(shot['data']))
