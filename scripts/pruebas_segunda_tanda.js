(async () => {
  ...
  await test('43 fuentes copiables sin errores de inicialización',()=>{
    assert(document.querySelectorAll('.catalogo-indice a').length===43,'Índice incompleto');
    assert(document.querySelectorAll('.receta-copia code').length===43,'Código de recetas incompleto');
