(async () => {
  ...
  await test('14 recetas nuevas y 30 fuentes copiables sin errores de inicialización',()=>{
    assert(document.querySelectorAll('.catalogo-indice a').length===30,'Índice incompleto');
    assert(document.querySelectorAll('.receta-copia code').length===30,'Código de recetas incompleto');
