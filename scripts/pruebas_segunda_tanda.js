(async () => {
  ...
  await test('32 fuentes copiables sin errores de inicialización',()=>{
    assert(document.querySelectorAll('.catalogo-indice a').length===32,'Índice incompleto');
    assert(document.querySelectorAll('.receta-copia code').length===32,'Código de recetas incompleto');
