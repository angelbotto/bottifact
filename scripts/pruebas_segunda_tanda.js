(async () => {
  ...
  await test('44 fuentes copiables sin errores de inicialización',()=>{
    assert(document.querySelectorAll('.catalogo-indice a').length===44,'Índice incompleto');
    assert(document.querySelectorAll('.receta-copia code').length===44,'Código de recetas incompleto');
