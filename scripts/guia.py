...
def generate():
 ...
 intro='''<section class="seccion" id="guia-empezar"><p class="ceja">Manual de uso / edición 04</p><h2>Una biblioteca para pensar con ella.</h2><p>Elige una pregunta. Construye el argumento. Dale a cada pieza una tarea.</p><p>Esta guía reúne <strong>71 componentes, nueve paletas y ocho recorridos de composición</strong>. Cada receta se puede ver y copiar; la base siempre incluye apariencia, sonido optativo, comentarios y ayudas de lectura.</p><p>Los ejemplos son ilustrativos: ninguna cifra de las muestras describe resultados reales de Liftit o Tikin.</p></section><nav class="biblioteca-rutas ancho" aria-label="Entradas a la guía"><a href="#componer"><strong>01 / Encontrar la forma</strong><small>Del objetivo a la combinación de componentes.</small></a><a href="#voz"><strong>02 / Escribir entre líneas</strong><small>Notas izquierda y derecha, subrayado, audio y ayudas.</small></a><a href="#ambientes"><strong>03 / Probar los temas</strong><small>Liftit, Blueprint y Hacker aplicados a documentos completos.</small></a><a href="#entrega"><strong>04 / Llevarla a tu agente</strong><small>Generar, validar e instalar en Hermes, Claude o Codex.</small></a></nav>'''
 intro+='<section id="guia-inventario"><h2>Las 71 piezas, a mano.</h2><p>Selecciona un nombre para ir al ejemplo, sus límites y el HTML completo. Apariencia y comentarios se usan desde los controles comunes del documento.</p><nav aria-label="Todos los componentes"><ul class="catalogo-indice">'+links+'</ul></nav></section>'
 compose=section('Antes de escoger piezas','guia-pregunta')+section('Recorridos que se pueden adaptar','guia-recorridos')+'<div class="cards-editoriales ancho">'+routes+'</div>'+section('Dar escala a la evidencia','guia-escala')
 ...
 themes=section('Elegir una voz visual','guia-temas')+'''<nav class="biblioteca-rutas ancho" aria-label="Ejemplos de temas"><a href="liftit.html"><span class="paleta-mini liftit" aria-hidden="true"><i></i><b></b></span><strong>Liftit / operación</strong><small>Rutas, datos y capacidad. Adaptación del azul medido en la web oficial.</small></a><a href="blueprint.html"><span class="paleta-mini blueprint" aria-hidden="true"><i></i><b></b></span><strong>Blueprint / sistema</strong><small>Plano azul, cuadrícula blanca y explicación de una confirmación.</small></a><a href="hacker.html"><span class="paleta-mini hacker" aria-hidden="true"><i></i><b></b></span><strong>Hacker / runbook</strong><small>Contrato, código destacado, terminal y recuperación.</small></a></nav><aside class="aviso"><span class="num">i</span><div><p class="titulo">Prueba la guía entera en cada tema.</p><p>Abre la llave sol/luna de la cabecera. Las paletas se aplican también a tablas, gráficas, mapas, notas y comentarios. El sonido empieza apagado: activa Sonidos y pulsa Repetir en una nota para escucharlo junto al gesto.</p></div></aside>'''
