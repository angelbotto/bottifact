...
if __name__=='__main__':
 p=argparse.ArgumentParser();p.add_argument('--puerto',type=int,default=8766);args=p.parse_args()
 print(f'Local con CSP: http://127.0.0.1:{args.puerto}/plantilla.html',flush=True)
