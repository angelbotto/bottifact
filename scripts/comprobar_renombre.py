...
file=ROOT/'auditoria/renombre-prueba.html';url='http://127.0.0.1:8768/auditoria/renombre-prueba.html'
...
try:
 ...
 save('bottifact-continuidad.json',{'documento_legacy_recuperado':True,'eventos_iguales':before==after,'comentarios':len(comments),'metodo':'Crear con título anterior y sin ID explícito, renombrar, recargar y comparar exportación.'})
 ...
 file.unlink(missing_ok=True);call('goto','--url','http://127.0.0.1:8768/sistema.html')
