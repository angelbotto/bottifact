...
def main():
 ...
 try:
  ...
  result=build(title,pages,description,theme=args.tema or (config.get('tema') if args.config else None),style=args.estilo or (config.get('estilo') if args.config else None))
