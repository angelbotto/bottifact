...
<a href="colaboracion.md" data-audio-hover><h3>Publicación externa por verificar</h3><p>La revisión conectada ya tiene un portal en el NAS. Falta completar el dominio público y probar el ingreso real por correo con otra persona.</p><span class="procedencia">LOWLIGHT · verificación externa pendiente</span></a>
