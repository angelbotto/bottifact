...
records=[]
for path in ['estandar.html','estandar-capitulos.html']:
 ...
 for w,h in [(320,740),(390,844),(1440,960)]:
  ...
  for theme in ['light','dark','sea','oliva','arcilla','ciruela']:
   ...
   records.append(r)
  if w in [320,1440]:
   Path('auditoria/capturas/'+path.removesuffix('.html')+'-'+str(w)+'.png').write_bytes(base64.b64decode(call('screenshot')['data']))
