...
(ROOT/'plantilla.html').write_text(start('Nota Tikin — la forma también explica')+body+script('interacciones.js')+globe_scripts()+script('geografia.js')+script('analitica.js')+script('graficas.js')+script('tablas.js')+script('sonido.js')+script('escritura.js')+script('escena.js')+script('reportes.js')+script('visor.js')+script('pestanas.js')+script('catalogo.js')+script('editorial.js')+script('codigo.js')+script('explorador.js')+script('revision.js'))
