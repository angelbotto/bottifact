...
const registry=JSON.parse(fs.readFileSync('packages/core/themes/themes.json','utf8'));
const source=fs.readFileSync('packages/core/components/reader.js','utf8').split('  // Variante optativa:')[0]+'})();';
let assertions=0;
