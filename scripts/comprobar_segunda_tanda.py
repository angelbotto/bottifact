...
if __name__=='__main__':
 ...
 tests=file('pruebas_segunda_tanda.js');save('segunda-componentes.json',tests)
 print(f"Segunda tanda: {tests['passed']} pasan, {tests['failed']} fallan",flush=True)
 assert not tests['failed'],tests
 call('goto','--url',args.url)
 old=file('pruebas_componentes.js');save('segunda-base.json',old)
