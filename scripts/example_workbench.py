...
def generate():
    intro = """<section id="decision"><p class="ceja">Margen / guía de trabajo</p><h2>Leer, contrastar y devolver contexto.</h2><p>La prioridad es reducir el trabajo entre encontrar un documento y preparar su siguiente versión. Esta guía permite probar las tablas con datos ficticios y entender qué queda guardado en el archivo, en el navegador o en la cuenta.</p><p>La barra inferior reúne Comentarios, Compartir y Preferencias. Pasa el cursor o enfoca un icono para identificarlo; también puedes recorrer las herramientas con las flechas del teclado. El contador está sobre el icono de Comentarios y muestra los hilos abiertos. Abre Comentarios → Añadir comentario y toca una celda, imagen, párrafo o gráfica. En escritorio también puedes hacer clic derecho sobre el contenido y elegir Comentar aquí; Mayús + clic derecho conserva el menú del navegador. Al escribir eliges si el comentario es compartido o privado. Comentarios reúne las referencias y la búsqueda; Compartir reúne enlace, acceso y gestión. El tema elegido por un lector conserva el diseño publicado.</p></section>"""
    scenarios = [
        (
            "liftit-deliveries",
