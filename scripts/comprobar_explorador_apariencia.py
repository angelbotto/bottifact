...
URL='http://127.0.0.1:8768/liftit.html'
def open_menu():
...
for w,h in [(320,740),(390,844),(1440,960)]:
 call('exec','--command',f'set viewport {w} {h}');open_menu();(ROOT/'auditoria/capturas'/f'apariencia-temas-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
 click('Letras','tab');(ROOT/'auditoria/capturas'/f'apariencia-letras-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']));evaluate('document.querySelector("[data-preferencia-tab=temas]").click();true')
