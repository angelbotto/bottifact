...
def generate():
 ...
 for theme,name in [('linear-light','colaborativo'),('linear-light','linear-light'),('linear-dark','linear-dark')]:
  (ROOT/(name+'.html')).write_text(build('Bottifact · Revisión compartida',[{'id':'contenido','titulo':'Revisión','html':content}],theme=theme,style='sobrio',document_id='nota-laboratorio-colaborativo'))
