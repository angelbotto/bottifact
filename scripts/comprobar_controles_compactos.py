...
import json,base64
from comprobar_navegador import call,evaluate,ROOT,save
call('goto','--url','http://127.0.0.1:8768/guia.html');call('screenshot')
rows=[]
for w,h in [(320,740),(390,844),(1440,960)]:
 ...
 (ROOT/'auditoria/capturas'/f'compacto-temas-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
 ...
 (ROOT/'auditoria/capturas'/f'compacto-visor-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
 ...
 (ROOT/'auditoria/capturas'/f'compacto-comentario-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
...
call('goto','--url','http://127.0.0.1:8768/hacker.html');call('screenshot')
...
for w,h in [(320,740),(390,844),(1440,960)]:
 call('exec','--command',f'set viewport {w} {h}');evaluate('document.querySelector(".codigo-sin-titulo").scrollIntoView({block:"center",behavior:"instant"});true');call('screenshot');(ROOT/'auditoria/capturas'/f'compacto-codigo-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
