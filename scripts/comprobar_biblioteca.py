...
checks=evaluate('''(async()=>{
 ...
 await test('57 recetas y nueve capítulos',()=>{assert(document.querySelectorAll('.pagina').length===9,'capítulos');assert(document.querySelectorAll('.receta-copia code').length===57,'recetas');});
