...
checks=evaluate('''(async()=>{
 ...
 await test('40 recetas y nueve capítulos',()=>{assert(document.querySelectorAll('.pagina').length===9,'capítulos');assert(document.querySelectorAll('.receta-copia code').length===40,'recetas');});
