...
checks=evaluate('''(async()=>{
 ...
 await test('44 recetas y nueve capítulos',()=>{assert(document.querySelectorAll('.pagina').length===9,'capítulos');assert(document.querySelectorAll('.receta-copia code').length===44,'recetas');});
