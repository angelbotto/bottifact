...
call('goto','--url','about:blank');call('goto','--url','http://127.0.0.1:8768/prioridades.html')
records=[]
for w,h in [(320,740),(390,844),(1440,960)]:
 ...
 for anchor in ['trayectoria-ejemplo','actividad-editorial-ejemplo','galeria-ejemplo']:
  ...
  Path(f'auditoria/capturas/ajustes-{anchor}-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
 ...
 Path(f'auditoria/capturas/ajustes-apuntes-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
