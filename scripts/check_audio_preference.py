...
URL='http://127.0.0.1:8768/examples/generated/standard.html'
...
save('audio-preference.json',{'cancelledActivation':cancelled,'paused':paused,'resumedAfterTrustedClick':resumed,'method':'Clics nativos Orca; promesa resume demorada 2500 ms y pagehide simulado. Contexto real. No audición humana.'})
