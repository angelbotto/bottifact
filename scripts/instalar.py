...
if __name__=='__main__':
 p=argparse.ArgumentParser(description=__doc__);p.add_argument('--destino',type=Path,required=True);p.add_argument('--actualizar',action='store_true');args=p.parse_args()
 try:
