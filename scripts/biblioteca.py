...
import re,json,html
CHAPTERS=[
 ('publicaciones','Publicaciones','Un cuaderno que invita a volver.','Portada, archivo, autoría y siguientes lecturas.',['archivo','autor','relacionados','cards','cards-trazadas','estanteria','invitacion','pie-editorial']),
 ('lectura','Artículos','Leer con contexto.','Anotaciones, fuentes, definiciones y cambios editoriales.',['articulo','referencias','glosario','metodologia','revisiones','manuscrita','apuntes','lista-estados','lista-proyectos','conversacion']),
 ...
 ('configuracion','Edición','Una voz, muchas maneras de editar.','Seis papeles, escritura animada, sonido, código y comentarios.',['apariencia','escritura','configuracion','codigo-poliglota','terminal','revision','marco','navegacion'])]
...
def build(root,start,script,appearance,recipes,labels,three):
 ...
 assert len(metadata)==len(set(m['id'] for m in metadata))==65
