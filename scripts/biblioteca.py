...
import re,json,html
CHAPTERS=[
 ('publicaciones','Publicaciones','Un cuaderno que invita a volver.','Portada, archivo, autoría y siguientes lecturas.',['archivo','autor','relacionados','cards','cards-trazadas']),
 ('lectura','Artículos','Leer con contexto.','Anotaciones, fuentes, definiciones y cambios editoriales.',['articulo','referencias','glosario','metodologia','revisiones','manuscrita','apuntes']),
 ...
 ('graficas','Gráficas','La escala también es una afirmación.','Valores alcanzables, fuentes visibles y alternativas en tabla.',['barras','lineas','temporal','dispersion','distribucion','calor','cascada','multiples','calendario','torta','areas','caja','velas','mapa-rutas','mapa-burbujas','atencion']),
 ...
 ('expresion','Espacio y gesto','Hay ideas que necesitan otra dimensión.','Geografía, composiciones con Three y sonido optativo.',['recorrido','xyz','etapas','columnas-mapa','arcos-mapa','almacen','sonido']),
...
def build(root,start,script,appearance,recipes,labels,three):
 ...
 assert len(metadata)==len(set(m['id'] for m in metadata))==57
