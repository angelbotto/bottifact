...
CHAPTERS=[
 ...
 ('reportes','Reportes','De la evidencia a la decisión.','Afirmaciones, compensaciones, riesgos y escenarios explícitos.',['ficha-entrega','hallazgo','decision','cronologia','criterios','riesgos','escenario','conciliacion','trayectoria']),
...
def build(root,start,script,appearance,recipes,labels,three):
 ...
 modules=['invitacion.js','mano.js','atencion.js','geografia.js','analitica.js','interacciones.js','multipagina.js','globo.js','flota.js','graficas.js','tablas.js','sonido.js','escritura.js','escena.js','reportes.js','visor.js','pestanas.js','editorial.js','catalogo.js','codigo.js','explorador.js','revision.js']
