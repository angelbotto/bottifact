...
CHAPTERS=[
 ...
 ('graficas','Gráficas','La escala también es una afirmación.','Valores alcanzables, fuentes visibles y alternativas en tabla.',['barras','lineas','temporal','dispersion','distribucion','calor','cascada','multiples','calendario','torta','areas','caja','velas','mapa-rutas','mapa-burbujas']),
...
def build(root,start,script,appearance,recipes,labels,three):
 ...
 assert len(metadata)==len(set(m['id'] for m in metadata))==54
 ...
 modules=['geografia.js','analitica.js','interacciones.js','multipagina.js','globo.js','graficas.js','tablas.js','sonido.js','escritura.js','escena.js','reportes.js','visor.js','pestanas.js','editorial.js','catalogo.js','codigo.js','explorador.js','revision.js']
