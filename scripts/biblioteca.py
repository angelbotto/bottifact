...
CHAPTERS=[
 ...
 ('lectura','Artículos','Leer con contexto.','Anotaciones, fuentes, definiciones y cambios editoriales.',['articulo','referencias','glosario','metodologia','revisiones','manuscrita','apuntes','lista-estados','lista-proyectos','conversacion','enlaces-icono','avisos-animados']),
 ('reportes','Reportes','De la evidencia a la decisión.','Afirmaciones, compensaciones, riesgos y escenarios explícitos.',['hallazgo','decision','cronologia','criterios','riesgos','escenario','conciliacion','trayectoria']),
 ...
 ('configuracion','Edición','Una voz, muchas maneras de editar.','Seis papeles, escritura animada, sonido, código y comentarios.',['apariencia','escritura','configuracion','codigo-poliglota','terminal','revision','marco','navegacion','codigo-lineas'])]
