...
def generate():
 ...
 delivery=section('Copiar, componer y comprobar','guia-generar')+'<p><a href="examples/generated/system.html">Revisión del stack, el skill y la evolución de Bottifact</a>.</p>'
 ...
 (ROOT/'examples/generated/guide.html').write_text(build('Bottifact · Guía de uso y componentes',pages,'Cómo construir documentos que se leen, se exploran y se revisan.'))
