...
fixture=ROOT/'tests/evidence/colaboracion-ui-prueba.html'
fixture.write_text(build('Prueba UI',[{'id':'contenido','titulo':'Prueba','html':(ROOT/'examples/content/collaborative-content.html').read_text()}],document_id='prueba-ui-'+uuid.uuid4().hex,theme='linear-light',style='sobrio'))
try:
 call('goto','--url','http://127.0.0.1:8768/tests/evidence/colaboracion-ui-prueba.html');call('screenshot')
  ...
  for w,h in [(320,740),(390,844),(1440,960)]:
   ...
   for theme in ['linear-light','linear-dark']:
    ...
    if scheme=='light' and w==1440:
     (ROOT/'tests/screenshots'/f'colaboracion-panel-{theme}-{w}.png').write_bytes(base64.b64decode(call('screenshot')['data']))
 ...
 call('goto','--url','http://127.0.0.1:8768/examples/generated/collaborative.html')
