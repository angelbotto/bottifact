...
def generate():
 ...
 for theme,name in [('linear-light','collaborative'),('linear-light','linear-light'),('linear-dark','linear-dark')]:
  (ROOT/'examples/generated'/(name+'.html')).write_text(build('Margen · Revisión compartida',[{'id':'contenido','titulo':'Revisión','html':content}],theme=theme,style='sobrio',document_id='nota-laboratorio-colaborativo'))
