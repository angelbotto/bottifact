...
def generate():
 ...
 for n in range(1,len(parts),2):
  ...
  for block in parts[n+1].strip().split('\n\n'):
   ...
   body+=html
 body+='<nav class="biblioteca-rutas ancho" aria-label="Seguir explorando"><a href="examples/generated/guide.html"><strong>Biblioteca y recetas</strong><small>Elegir piezas por intención.</small></a><a href="examples/generated/themes.html"><strong>Familias y modos</strong><small>Encontrar la voz del documento.</small></a><a href="https://github.com/angelbotto/bottifact"><strong>Repositorio Bottifact</strong><small>Código, skill y versiones.</small></a></nav>'
 (ROOT/'examples/generated/system.html').write_text(build('Bottifact · El sistema y su evolución',[{'id':'sistema','titulo':'El sistema','html':body}],description='Biblioteca, generador y skill portable. Qué funciona hoy y qué conviene construir después.',theme='linear',mode='system',document_id='bottifact-sistema'))
