...
URL='http://127.0.0.1:8768/evidencia.html'
call('goto','--url',URL);call('exec','--command','set viewport 1440 960');call('screenshot')
tests=file('pruebas_evidencia.js');save('evidencia-pruebas.json',tests)
...
for kind in ['sankey','cohortes','sensibilidad','gantt','embudo','incertidumbre','imagen','relato']:
 ...
 shot=call('screenshot');(ROOT/'auditoria/capturas'/('evidencia-'+kind+'.png')).write_bytes(base64.b64decode(shot['data']))
