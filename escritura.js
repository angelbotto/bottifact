...
(() => {
  ...
  class NotaEscritura {
    constructor(element){
      ...
      this.element=element;this.paths=paths;this.dead=false;this.animations=[];this.epoch=0;
      ...
      this.intersection=new IntersectionObserver(entries=>{if(!entries[0].isIntersecting)this.finish();});this.intersection.observe(element);
    ...
    play(){
      ...
      if(this.motion.matches||document.hidden||!this.paths[0].animate)return;
