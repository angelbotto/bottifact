...
[docs/portal-operations.md](portal-operations.md) documenta publicación, identidad, acceso privado/público/invitado, tokens para agentes, respaldos y limitaciones. No mezcles esta capacidad con el modo local: abrir el HTML descargado no sincroniza con el NAS. La importación de comentarios locales al servidor todavía no está implementada.
...
Las revisiones nuevas se preparan como borrador. El creador compara texto y referencias antes de publicar la versión en el mismo enlace. Los estados de contexto avisan de un fragmento modificado, trasladado, ausente o ambiguo; no aplican un cambio automáticamente. Consulta [docs/portal-operations.md](portal-operations.md) para permisos, avisos y operación.
