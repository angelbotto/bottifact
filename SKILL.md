...
La biblioteca conectada ofrece galería, lista, tabla y mapa de relaciones, con clasificación automática corregible. Lee [biblioteca-conectada.md](biblioteca-conectada.md) para buscar, organizar, registrar procedencia y retomar una sesión desde el contexto exportado. Las conexiones se basan en etiquetas y colecciones compartidas; no las describas como dependencias ni conclusiones de IA.
