...
La vista consulta cambios cada 12 segundos. No hay presencia en vivo ni coedición del texto. El dominio público artifacts.botto.is está activo. La biblioteca reúne documentos propios y compartidos con búsqueda FTS5, carga por cursor y previews estáticas aisladas. El lector compartido ocupa la pantalla; la gestión y el historial quedan en el control del creador. La importación administrativa permite trasladar sitios anteriores a documentos privados. Sigue pendiente ampliar la prueba de correo a más dominios invitados, migrar comentarios locales y comparar visualmente versiones. CRDT sólo merece evaluación si varias personas editan simultáneamente el cuerpo.
