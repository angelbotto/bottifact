...
- `python3 scripts/build.py` y `python3 scripts/validate.py`: pasan los cuatro HTML,
...
- `python3 scripts/check_second_batch.py`: 21 pruebas nuevas y 15 de la base;
...
- `python3 scripts/check_second_output.py`: 10 comprobaciones de ancla inicial,
