...
las fuentes. Evidencia: referencia-piezas-medidas.json y reference-timeline-measurements.json.
...
remotas copiadas del sitio. Cada receta contiene HTML completo, criterio y límites en docs/components.md.
La invitación conserva su textura: la capa de marco no sustituye sus pseudoelementos.

El artefacto examples/generated/priorities.html distingue capacidades propuestas (persistencia de comentarios,
estados completos, migraciones, lectura asistida y composiciones) de estas piezas ya implementadas.

## Verificaciones ejecutadas

- Ensamblador, validador de biblioteca y validador de examples/generated/priorities.html; 71 recetas presentes.
...
`reference-pulse-measurements.json` confirma también por estilo calculado `ping`, duración `1s` e
