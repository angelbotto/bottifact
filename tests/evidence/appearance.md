...
extrae el círculo desde docs/components.md para no mantener dos versiones distintas.
...
- `scripts/check_appearance.py`: 8 contratos de interacción y 21 regresiones de la
...
- `examples/generated/chapters.html`, con preferencias guardadas de Técnico/trama/cómoda: conserva
