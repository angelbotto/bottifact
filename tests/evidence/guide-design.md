...
selectores en liftit-theme-source.json. El sitio usa Inter y Eina03_Bold; se conservaron Geist,
...
- La documentación docs/artifact-contract.md describía todavía un tono sintetizado de 450 ms y negaba que el
...
- docs/components.md abría con un selector histórico e instrucciones que podían llevar a omitir
...
nota-tikin y skill_view(preprocess=False) lee docs/composition.md, packages/core/registry/use-cases.json y Blueprint. Los enlaces
...
scripts/check_guide.py usa el CLI público de Orca contra localhost:8768 con la CSP de
scripts/serve.py. Presenta un frame por página y mide cada paleta tras su evento de cambio y
