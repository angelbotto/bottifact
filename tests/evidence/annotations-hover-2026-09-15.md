...
El motor packages/core/components/handwriting.js ya iniciaba la escritura y subrayado al ver un 30 % de la caja, una sola vez.
...
Documentación y receta completa actualizadas. Se corrige en docs/composition.md la instrucción antigua
