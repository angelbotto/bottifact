...
107.1458 ms están en docs/editorial-reference.md; aquí se usa síntesis propia de 60 ms.

## Qué se comprobó

- Ensamblar y validar: 57 recetas, dependencias incrustadas, IDs, rejilla, regiones y seis paletas.
- `scripts/check_gesture.py`: nueve contratos de entrada, avance, repetición y cancelación de
...
- `scripts/check_gesture_audio.py`: clics, movimientos y rueda nativos de Orca. Dos entradas
...
- `scripts/check_library.py`: 162 combinaciones (nueve capítulos × seis paletas ×
