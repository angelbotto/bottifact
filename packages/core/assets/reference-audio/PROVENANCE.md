# Grabaciones originales de cmrg.me

Descargadas el 15 de septiembre de 2026 por petición explícita de Angel de usar los sonidos
originales en lugar de la síntesis. Archivos sin modificar; URL y SHA-256 en
../../tests/evidence/sounds-cmrg.json. El footer del sitio enlaza WTFPL: https://www.cmrg.me/ y
https://www.wtfpl.net/. No se encontró un aviso de licencia individual dentro de cada MP3.

Los bytes originales están incrustados en packages/core/components/audio.js; no hay fetch, archivos relativos ni red
