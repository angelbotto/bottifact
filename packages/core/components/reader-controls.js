...
(() => {
  ...
  function mount() {
    ...
    style.textContent = `
    .bottifact-toolbar{position:fixed;bottom:22px;left:0;right:0;width:max-content;margin-inline:auto;z-index:130;display:flex;align-items:center;gap:3px;padding:5px;border:1px solid var(--linea,#cfcac4);border-radius:14px;background:var(--papel,#fffaf5);color:var(--tinta,#241e19);box-shadow:0 4px 24px #0002;font:13px/1.45 var(--sans,system-ui)}
    .bottifact-toolbar>button,.bottifact-toolbar>details>summary,.bottifact-toolbar .apariencia-menu>summary{display:grid;place-items:center;width:42px;height:42px;min-width:42px;min-height:42px;padding:0;border:0;border-radius:9px;background:transparent;color:inherit;cursor:pointer;list-style:none;margin:0}
    ...
    .bottifact-toolbar [hidden]{display:none!important}.bottifact-controls-ready .revision-barra{display:none!important}.bottifact-controls-ready body{padding-bottom:90px}
