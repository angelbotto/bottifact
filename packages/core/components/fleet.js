...
(()=>{
 ...
 class Fleet{
  ...
  init3D(){
   if(!window.THREE||!window.NotaGeografia||!window.NotaGlobo)throw Error('Faltan Three, packages/core/components/geography.js o packages/core/components/globe.js.');
