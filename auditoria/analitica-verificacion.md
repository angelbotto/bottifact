...
- `python3 scripts/ensamblar.py` y `python3 scripts/validar.py`: seis HTML sincronizados,
  54 recetas, IDs, rejilla, dependencias, CSP, tokens, enlaces y sintaxis de los módulos.
- `python3 scripts/comprobar_analitica.py`: 13 contratos de datos e interacción. Comprueba
...
- `python3 scripts/comprobar_analitica_webgl.py`: columnas, arcos y almacén con renderer real.
...
- Se ejecutó también `scripts/comprobar_lectura.py` tras corregir el recorte: seguimiento,
