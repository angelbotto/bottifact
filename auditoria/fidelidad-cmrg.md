...
- Reenie Beanie 400; nota lateral 28.5px/32px, tracking −.7125px; nota editorial grande
  ...
  La fuente ya incrustada es idéntica byte por byte. El problema era que mano.js la sustituía
...
Procedencia y hashes: sonidos-cmrg.json y assets/sonidos-cmrg/PROCEDENCIA.md.
Los bytes incrustados en audio.js son idénticos a esos archivos; no hay fetch ni descargas
...
sintetizador cuando audio.js está presente. La implementación aislada antigua se conserva.
