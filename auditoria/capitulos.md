...
“nota / tikin”, añadir colores y analizar nuevas piezas. Se implementa `informe.html`, con
Resumen/Evidencia/Prototipo/Próximos pasos, y se mantiene `multipagina.html` como ejemplo mínimo.
...
reúne 32 recetas copiables. El informe completo también está documentado en componentes.md,
...
- `python3 scripts/ensamblar.py` y `python3 scripts/validar.py`: cinco artefactos sincronizados,
...
- `python3 scripts/comprobar_capitulos.py`: 8 contratos de interacción (historial real
...
entregadas: véase [capitulos-propuesta.md](capitulos-propuesta.md).
